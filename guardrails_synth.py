...
def build_events():
    ...
    def ts(mins):
        # return a real datetime so oracledb binds it as a TIMESTAMP directly,
        # instead of a string that Oracle tries (and fails) to parse against
        # NLS_DATE_FORMAT -> ORA-01843 "not a valid month".
        return now - _dt.timedelta(minutes=mins)
