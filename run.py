...
if __name__ == "__main__":
    import sys
    # steps can be passed on the command line, e.g.:
    #   python -m ingestion.run guardrails
    #   python -m ingestion.run feed_dictionary feed_catalog
    # with no args, the full pipeline runs.
